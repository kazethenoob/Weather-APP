...
let weather__realfeel = document.querySelector('.weather_realfeel');
let weather__humidity = document.querySelector('.weather_humidity');
let weather__wind = document.querySelector('.weather_wind');
let weather__pressure = document.querySelector('.weather_pressure');
